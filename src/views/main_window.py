...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.label = QLabel(
            "Добро пожаловать в MOEX Stock Screener!"
            "\nОкружение и логирование настроены успешно.",
            self,
        )
        self.label.setStyleSheet(
            "font-size: 16px; font-weight: bold; qproperty-alignment: 'AlignCenter';"
        )
        ...
        self.statusBar().showMessage(
            "Приложение готово к работе. Сетевой уровень инициализирован."
        )
